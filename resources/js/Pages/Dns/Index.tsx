...
export default function Index({ zones, filters }: Props) {
    const [searchQuery, setSearchQuery] = useState(filters.search || "");
    const [showCreateForm, setShowCreateForm] = useState(false);

    const { data, setData, post, processing, errors, reset } = useForm({
        domain: "",
        sync_cloudflare: false,
    });
    ...
    return (
        <AuthenticatedLayout
            ...
            breadcrumbs={[{ title: "DNS Management" }]}
        >
                            ...
                            <form onSubmit={submit} className="p-6">
                                <div className="max-w-xl space-y-4">
                                    ...
                                    <div className="flex items-center gap-2">
                                        ...
                                        />
                                        <label
                                            htmlFor="sync_cloudflare"
                                            className="text-sm text-gray-600 dark:text-gray-400"
                                        >
                                            Automatically sync with Cloudflare
                                            (requires API token in settings)
                                        </label>
                                    </div>
                                </div>
                            </form>
                                            ...
                                            >
                                                ...
                                                <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
                                                    {searchQuery
                                                        ...
                                                        : "Get started by adding your first DNS zone."}
                                                </p>
                                            </td>
                                        </tr>
                                    )}
