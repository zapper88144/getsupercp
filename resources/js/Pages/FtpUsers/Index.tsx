...
export default function Index({ ftpUsers }: Props) {
    ...
    const filteredUsers = ftpUsers.filter(user => 
        ...
        user.homedir.toLowerCase().includes(searchQuery.toLowerCase())
    );
                            ...
                            <section className="max-w-xl">
                                <header>
                                    ...
                                    <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">
                                        Add a new user with FTP access to a specific directory.
                                    </p>
                                </header>
                                ...
                                <form onSubmit={submit} className="mt-6 space-y-6">
                                    ...
                                    <div>
                                        <InputLabel htmlFor="homedir" value="Home Directory" />
                                        <TextInput
                                            id="homedir"
                                            className="mt-1 block w-full"
                                            value={data.homedir}
                                            onChange={(e) => setData('homedir', e.target.value)}
                                            required
                                            placeholder="/home/super/getsupercp/storage/app/public/www"
                                        />
                                        <InputError message={errors.homedir} className="mt-2" />
                                        <p className="mt-1 text-xs text-gray-500">
                                            The directory this user will be restricted to.
                                        </p>
                                    </div>

                                    <div className="flex items-center gap-4">
                                        <PrimaryButton disabled={processing}>Create FTP User</PrimaryButton>
                                    </div>
                                </form>
                            </section>
                        </div>
                                ...
                                <table className="w-full text-left border-collapse">
                                    <thead>
                                        <tr className="border-b border-gray-200 dark:border-gray-700">
                                            ...
                                            <th className="py-3 px-4 font-semibold text-sm">Home Directory</th>
                                            ...
                                            <tr key={user.id} className="border-b border-gray-100 dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700/50 group transition-colors">
                                                ...
                                                <td className="py-4 px-4">
                                                    <div className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400">
                                                        ...
                                                        <span className="truncate max-w-xs" title={user.homedir}>
                                                            {user.homedir}
                                                        </span>
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                <td colSpan={4} className="py-12 text-center text-gray-500">
                                                    <div className="flex flex-col items-center gap-2">
                                                        ...
                                                        <span>{searchQuery ? `No users matching "${searchQuery}"` : 'No FTP users found.'}</span>
                                                    </div>
                                                </td>
                                            </tr>
                                        )}
