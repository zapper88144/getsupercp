...
export default function Index({ accounts, filters, stats }: Props) {
    ...
    return (
        <AuthenticatedLayout
            ...
            breadcrumbs={[{ title: "Email Accounts" }]}
        >
                        ...
                        <div className="overflow-hidden rounded-xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-2xl font-bold text-gray-900 dark:text-white">
                                        {(stats.totalQuota / 1024).toFixed(1)}{" "}
                                        GB
                                    </p>
                                </div>
                            </div>
                                            ...
                                            <td className="px-6 py-4 text-right">
                                                <div className="flex justify-end gap-2">
                                                    <Link
                                                        ...
                                                        className="rounded-lg p-2 text-gray-400 opacity-0 transition-opacity group-hover:opacity-100 hover:bg-gray-100 hover:text-indigo-600 dark:hover:bg-gray-600 dark:hover:text-indigo-400"
