...
export default function Index({ databases, filters }: Props) {
    ...
    const filteredDatabases = databases.data;
                ...
                <div className="mx-auto max-w-7xl space-y-6 sm:px-6 lg:px-8">
                            ...
                            <section className="max-w-xl">
                                <header>
                                    ...
                                    <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">
                                        Provision a new MySQL or PostgreSQL
                                        database.
                                    </p>
                                </header>
                    ...
                    <div className="bg-white shadow sm:rounded-lg dark:bg-gray-800 overflow-hidden">
                        <div className="p-6">
                            ...
                            <Pagination links={databases.links} />
                        </div>
                    </div>
                </div>
            </div>
